...
//
// ⚠️ 다른 학교에서 이 코드를 복사해서 쓰는 경우 반드시 주의하세요:
// 아래 SUPABASE_URL / SUPABASE_ANON_KEY 는 특정 학교의 실제 데이터베이스와 연결되어 있습니다.
// 이 값을 바꾸지 않고 그대로 배포하면 학생들이 등록한 기록이 원래 학교의 DB로 들어갑니다!
// 반드시 본인 학교의 새 Supabase 프로젝트를 만들고, 그 프로젝트의 값으로 교체한 뒤 배포하세요.
// (자세한 절차는 README.md의 "다른 학교에서 재사용하기" 참고)
// ============================================================
const CONFIG = {
